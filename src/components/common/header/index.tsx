        ...
        <div className="flex flex-wrap items-center justify-center mx-auto py-3 gap-12">
          ...
          <div className="flex justify-center items-center p-2 gap-12 flex-shrink-0">
            <Link
              key="home"
              href="/"
              className={`text-[18px] font-[600] text-center ${
                usePathname() === "/"
                  ? " text-[#3B823E]"
            ...
            <button
              onClick={handlePlantOpen}
              id="dropdownNavbarLink"
              data-dropdown-toggle="dropdownNavbar"
              className="relative p-0 flex items-center justify-between outline-none"
            >
              <div
                className={`text-[18px] font-[600] text-center ${
                  usePathname() === "/caycanh"
              ...
              {isPlantOpen && (
                <div
                  id="dropdownNavbar"
                  className="absolute top-full bg-white text-base z-10 list-none divide-y divide-gray-100 rounded shadow my-4 w-44"
                >
                  <ul className="py-1" aria-labelledby="dropdownLargeButton">
                    <li>
                      <a
                        href="/product"
                        className="text-left text-[16px] font-[500] hover:bg-gray-100 block px-4 py-2"
                      >
                        Cây cảnh A
                      </a>
                    </li>
