...
const categories: CategoryItem[] = [
  {
    ...
    label: "Cây cảnh",
    children: [
      { key: "cay-canh-de-ban", label: "Cây cảnh để bàn" },
      { key: "cay-thuy-sinh", label: "Cây thủy sinh" },
      { key: "terrarium", label: "Terrarium" },
      { key: "cay-bonsai", label: "Cây bonsai" },
      { key: "sen-da", label: "Sen đá" },
      { key: "xuong-rong", label: "Xương rồng" },
      { key: "cay-chau-treo", label: "Cây chậu treo" },
      { key: "cay-an-trai", label: "Cây ăn trái" },
      { key: "cay-canh-noi-that", label: "Cây cảnh nội thất" },
      { key: "cay-canh-ngoai-that", label: "Cây cảnh ngoại thất" },
    ],
  },
  {
    key: "chau-canh",
